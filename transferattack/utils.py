...
cnn_model_paper = ['resnet18', 'vgg16', 'densenet121', 'efficientnet_b0', 'mobilenet_v3_small', 'resnext50_32x4d']
vit_model_paper = ['vit_base_patch16_224', 'cait_s24_224', 'pit_b_224', 'visformer_small', 
                   'swin_tiny_patch4_window7_224', 'deit_tiny_patch16_224', 'coat_tiny']
...
def load_pretrained_model(cnn_model=[], vit_model=[]):
    ...
    for model_name in vit_model:
        if model_name == 'vit_base_patch16_224':
            ...
            yield model_name, timm.create_model(model_name, pretrained=True, pretrained_cfg_overlay=dict(file='./vit_weight/cait_s24_224.bin')) #              
        elif model_name == 'deit_base_distilled_patch16_224': 
            yield model_name, timm.create_model(model_name, pretrained=True, pretrained_cfg_overlay=dict(file='./vit_weight/deit_base_distilled_patch16_224.bin')) #              
